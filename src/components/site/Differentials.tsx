        ...
        <div className="grid gap-5 sm:grid-cols-2 lg:grid-cols-5">
          {differentials.map((d, i) => {
            ...
            return (
              ...
              >
                <div className="w-14 h-14 rounded-xl bg-gradient-to-br from-primary/20 to-primary/5 border border-primary/30 grid place-items-center mb-4 group-hover:shadow-[0_0_25px_oklch(0.72_0.21_45/0.5)] transition-all">
